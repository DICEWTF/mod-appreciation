...
enum
{
  ...
  GOSSIP_BOOST_TEXT_DISABLE = 6000000,
  GOSSIP_BOOST_TEXT_LEVEL_TOO_HIGH = 6000001,
  GOSSIP_BOOST_TEXT_CHOOSE_SPECIALIZATION = 6000002,
  GOSSIP_BOOST_TEXT_CONFIRM_SPECIALIZATION = 6000003
};
